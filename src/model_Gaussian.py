...
class Model_NLP:
    def __init__(self):
        """Model for classification of italian words
        Attributes:
            model: Gaussina classifiar 
            vectorizor: tfidf embeddings
        """
    ...
    def pickle_vectorizer(self, path='..\\models\\embeddings-tfIdf.pkl.pkl'):
    ...
    def pickle_clf(self, path='..\\models\\Gaussian_model.pkl'):
